...
<body>
	...
	<form name="loginform" action="./AlterUserInfo_DB.jsp" method="GET" onSubmit="return validateForm()" accept-charset="UTF-8">
		<table class="form-table">
			<tr> 
				<th class="alter-title" colspan="2">정보 수정</th>
			</tr>
			<tr>
				<td class="alter-title">아이디</td>
				<td>
					<input type="text" name="id" id="id" value="<%=MEMBER_ID%>">
					<input type="hidden" name="before-id" id="before-id" value="<%=before_id%>">
				</td>
			</tr>
			<tr>
				<td class="alter-title">비밀번호</td>
				<td>
					<input type="password" name="password" value="<%=MEMBER_PW%>">
					<input type="hidden" name="before-password" id="before-password" value="<%=MEMBER_PW%>">
				</td>
			</tr>
			<tr>
				<td class="alter-title">비밀번호 확인</td>
				<td><input type="password" name="confirm_password" placeholder="confirm password"></td>	
			</tr>
			<tr>
				<td class="alter-title">이름</td>
				<td><input type="text" name="name" value="<%=MEMBER_NAME%>"></td>
			</tr>
			<tr>
				<td class="alter-title">전화번호</td>
				<td>
					...
					<span>-</span>
					<input type="text" name="phone2" value="<%=TEL2%>" maxlength="4" style="width:80px;">
					<input type="text" name="phone3" value="<%=TEL3%>" maxlength="4" style="width:80px;">
					<br/>
			...
			<tr>
				<td class="alter-title">이메일</td>
				<td>
					<input type="text" name="mail1" value="<%=EMAIL1%>" style="width:100px; text-align:right;">
					<span>@</span>
					<input type="text" name="mail2" value="<%=EMAIL2%>" style="width:100px;">
			...
			<tr>
				<td class="alter-title">생년월일</td>
				<td>
					<select id="year" name="year" onchange="setYear(this), setRrn_2()">
					</select>
					<select id="month" name="month" onchange="setMonth(this)">
					</select>
					<select id="day" name="day" onchange="setDay(this)">
					</select>
			...
			<tr>
				<td class="alter-title">주민등록번호</td>
				<td><input type="text" name="rrn" value="000000" style="width:80px; text-align:right;" readonly> 
				<b>-</b> 
				<input type="text" name="rrn_2" value="<%=RRN_BACK%>" style="width:80px;"></td>
			</tr>
			<tr>
				<td class="alter-title">주소</td>
				<td>
				<input id="postcode" type="text" name="postcode" value="<%=POSTCODE %>" readonly>
					...
					<input id="detailAddr" type="text" name="detailAddr" value="<%=DETAILADDRESS %>" value="">
				</td>
			</tr>
			<tr align="right">
				<td class="alter-title" colspan="2"><input type="submit" value="수정">&nbsp;<input type="submit" value="회원 탈퇴" formaction="./DeleteUser.jsp">&nbsp;<input type="reset" value="Reset"></td>
			</tr>
		</table>
	</form>
</body>
